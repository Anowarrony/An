      ...
      return RedirectToAction("PostAnswer","Home");
        ...
        public ActionResult DeleteQuestion(int id)
        {
            ...
            try
            {
                ...
                {
                    return RedirectToAction("ThrowProcessingErrorMsg");
                }
            }
            catch (Exception e)
            {
        ...
        public ViewResult ThrowProcessingErrorMsg()
        {
        ...
        public JsonResult RatePost(int score,int ansId)
        {
            ...
            if (Request.IsAuthenticated)
            {
                ...
                {
                    var checkIsUserRatedThisAns = _db.Rating.Any(m => m.RaterId.Equals(authUserId)&&m.AnswerId.Equals(ansId));
        ...
        public ViewResult ThrowJavascriptOffMessage()
        {
            return View();
        }
    }
